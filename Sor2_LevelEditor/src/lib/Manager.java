...
public class Manager {
    ...
    //private ArrayList<lib.anim.CharacterDefinition> bufferedChars;
    
    private lib.elc.CharacterDefinition currCharacter;
    ...
    public Manager(String romFileName, long animsListAddress, long hitsListAddress, long weaponsListAddress, long portraitsAddress) throws FileNotFoundException, IOException{
        ...
        //bufferedChars = new ArrayList<lib.anim.CharacterDefinition>();
...
//    }
//    
//    private lib.anim.CharacterDefinition getBufferedCharacter(int charId){
...
//    }
    ...
    public void setCharacter(int charId, int animsCount, long paletteAddress, int animsType) throws IOException{
        ...
        lib.elc.CharacterDefinition newChar;
...
//        if (currCharacter!= null) bufferCurrentCharacter();
    ...
    public lib.elc.CharacterDefinition getCharacter(){
