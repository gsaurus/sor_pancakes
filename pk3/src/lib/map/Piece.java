...
public class Piece{
    ...
    public static Piece read(RandomAccessFile rom, long address, int width, int height) throws Exception{
    ...
    public static Piece read(RandomDataStream art, int offset, int width, int height) throws Exception{
       int numTiles = width*height;
       Piece piece = new Piece(width,height);
       for (int i = 0 ; i < numTiles ; ++i){
    ...
    public void writeArt(RandomAccessFile rom, long address, BufferedImage image, Palette palette) throws Exception {
